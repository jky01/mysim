...
def train() -> None:
    ...
    parser.add_argument("--env", type=str, default="donkey-mountain-track-with-sam-v0", help="environment ID")
    ...
    # 註冊新的環境，使用 GeneratedRoadsEnvWithSAM
    register(
        id="donkey-mountain-track-with-sam-v0",
        entry_point="gym_donkeycar.envs.donkey_env:GeneratedRoadsEnvWithSAM",
        kwargs={
            "conf": {
